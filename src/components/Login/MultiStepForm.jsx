...
const MultiStepForm = () => {
  ...
  return (
    ...
    {/* <Layout> */}
      ...
      {/* Background */}
      <div className="relative min-h-[calc(100vh-160px)]- min-h-fit- min-h-screen bg-gradient-to-br from-indigo-100 via-white to-emerald-100 overflow-hidden">
        {/* Form Container */}
        <div className="relative z-10 flex items-center justify-center p-6- min-h-[calc(100vh-160px)]- h-screen- min-h-screen">
          <motion.div
            key={step}
